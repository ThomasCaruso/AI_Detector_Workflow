...
def test_pipeline_runs_with_beam(tmp_path):
    ...
    stats = json.loads((exp.root / "pipeline_stats.json").read_text(encoding="utf-8"))
    assert stats["total_model_calls"] == 15
